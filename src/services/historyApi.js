...
export async function fetchSummaries() {
  const res = await fetch(`${API_BASE_URL}/history/summaries`);
  if (!res.ok) throw new Error("Failed to load summaries");
  return await res.json();
}

export async function fetchSummaryById(id) {
  const res = await fetch(`${API_BASE_URL}/history/summaries/${id}`);
  if (!res.ok) throw new Error("Failed to load summary");
  return await res.json();
}

export async function fetchSavedVideos() {
  const res = await fetch(`${API_BASE_URL}/history/videos`);
  if (!res.ok) throw new Error("Failed to load videos");
  return await res.json();
}

export async function fetchChats() {
  const res = await fetch(`${API_BASE_URL}/history/chats`);
  if (!res.ok) throw new Error("Failed to load chats");
  return await res.json();
}

export async function fetchQuizzes() {
  const res = await fetch(`${API_BASE_URL}/history/quizzes`);
  if (!res.ok) throw new Error("Failed to load quizzes");
  return await res.json();
}

export async function fetchAttempts() {
  const res = await fetch(`${API_BASE_URL}/history/attempts`);
...
export async function fetchChatById(id) {
  const res = await fetch(`${API_BASE_URL}/history/chats/${id}`);
...
export async function fetchAttemptById(id) {
  const res = await fetch(`${API_BASE_URL}/history/attempts/${id}`);
...
export async function fetchQuizById(quizId) {
  const res = await fetch(`${API_BASE_URL}/history/quizzes/${quizId}`);
